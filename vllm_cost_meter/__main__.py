...
from vllm_cost_meter.detector import VllmConfig, detect_vllm_config
...
def main():
    ...
    override = None
    if args.model or args.quantization or args.tensor_parallel_size:
        override = VllmConfig(
            model_id=args.model or "unknown",
            quantization=args.quantization or "float16",
            tensor_parallel_size=args.tensor_parallel_size or 1,
        )
    config = detect_vllm_config(override=override, base_url=args.vllm_url)
